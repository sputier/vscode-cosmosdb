...
Browse and query your MongoDB databases both locally and in the cloud using [_scrapbooks_](#mongo-scrapbooks) with rich Intellisense. Connect to Azure and manage your Cosmos DB databases with support for MongoDB, Graph (Gremlin), and DocumentDB.
